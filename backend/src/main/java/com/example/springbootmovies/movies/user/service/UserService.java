package com.example.springbootmovies.movies.user.service;

import com.example.springbootmovies.movies.user.entity.UserEntity;
import com.example.springbootmovies.movies.user.repository.UserRepository;
import com.example.springbootmovies.movies.exception.BadRequestException;
